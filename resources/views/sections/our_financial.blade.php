        ...
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="col-12 col-md-6 mb-4">
                        <div class="card h-100 p-3" style="background: #370E45">
                            <div class="card-body d-flex flex-column">
                                <h3 class="card-title fw-bold text-white fs-5">{{ $financial_investment?->lang('title') }}</h3>
                                ...
                                @if ($financial_investment->lists->count() > 0)
                                    ...
                                    <p class="mb-2 d-flex align-items-center text-white fs-6">
                                        ...
                                        <span class="fs-6 text-white ms-2">{{ $list?->lang('title') }}</span>
                                    </p>
                                    @endforeach
                                @endif
                               
                                <div class="mt-auto mt-3">
                                    <a href="{{ route('financial-investment-request.index', ['id' => base64urlEncode($financial_investment->id)]) }}" class="btn btn-request">{{ __('Request Service') }}</a>
                                </div>
                ...
                <div class="text-center at-service">
                    ...
                    <p>{{ __('To request a consultation or access any of our financing or investment services, please fill out
                        the Unified Application Form, and our team will contact you to support your journey toward the
                        most suitable financing or investment opportunity') }}</p>
                </div>
            </div>
        </div>
    </div>
